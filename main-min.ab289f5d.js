...
},{"process":"../node_modules/process/browser.js"}],"js/main-min.js":[function(require,module,exports) {
var define;
...
function findScrollingElement(e) {
  do {
    if (e.clientHeight < e.scrollHeight || e.clientWidth < e.scrollWidth) return e;
...
(function () {
  ...
  function i() {
    document.body.classList.toggle("certificate-open"), e.modal.classList.toggle("is-hidden");
  }

  e.openModalBtn.addEventListener("click", i), e.closeModalBtn.addEventListener("click", i);
})(), function () {
  var d = document;

  var r = window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || function (e) {
    window.setTimeout(e, 1e3 / 60);
  };

  function a(e, i) {
    var t = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 1500;
    isDomElement(e) && (e = e.offsetTop);
    var o = document.documentElement.offsetTop || document.body.parentNode.offsetTop || document.body.offsetTop,
        s = e - o,
        n = 0;
    console.log("start:", o), console.log("to:", e), console.log("change:", s);

    var l = function l() {
      n += 20;
      var e = Math.easeInOutQuad(n, o, s, t);
      e = e, document.documentElement.scrollTop = e, document.body.parentNode.scrollTop = e, document.body.scrollTop = e, n < t ? r(l) : i && "function" == typeof i && i();
    };
  ...
  !function () {
    var e = d.getElementById("programLink"),
        i = d.getElementById("aboutLink"),
        t = d.getElementById("how_we_doLink"),
        o = d.getElementById("contactsLink");
    var s = d.getElementById("program_scroll"),
        n = d.getElementById("about_scroll"),
        l = d.getElementById("how_we_do_scroll"),
        r = d.getElementById("contacts_scroll");
    e.addEventListener("click", function (e) {
      a(s, e);
    }, !1), programLink2.addEventListener("click", function (e) {
      a(s, e);
    }, !1), i.addEventListener("click", function (e) {
      a(n, e);
    }, !1), aboutLink2.addEventListener("click", function (e) {
      a(n, e);
    }, !1), t.addEventListener("click", function (e) {
      a(l, e);
    }, !1), how_we_doLink2.addEventListener("click", function (e) {
      a(l, e);
    }, !1), o.addEventListener("click", function (e) {
      a(r, e);
    }, !1), contactsLink2.addEventListener("click", function (e) {
      a(r, e);
    }, !1), contactsLink3.addEventListener("click", function (e) {
      a(r, e);
    }, !1);
  }();
}(), Math.easeInOutQuad = function (e, i, t, o) {
  return (e /= o / 2) < 1 ? t / 2 * e * e + i : -t / 2 * (--e * (e - 2) - 1) + i;
}, Math.easeInCubic = function (e, i, t, o) {
  return i + t * ((e /= o) * e * e);
}, Math.inOutQuintic = function (e, i, t, o) {
  o = (e /= o) * e, e *= o;
  return i + t * (6 * e * o + -15 * o * o + 10 * e);
};
var links = document.querySelectorAll("[data-modal-link]"),
    MODAL_HIDDEN_CLASS = "is-hidden",
    BODY_SCROLL_DISABLE_CLASS = "modal-open",
    BURGER_VISIBLE = "is-active";

function hideModal() {
  var e = document.querySelector(".backdrop-mobile"),
      i = document.querySelector(".hamburger");
  e.classList.add(MODAL_HIDDEN_CLASS), i.classList.remove(BURGER_VISIBLE), document.body.classList.remove(BODY_SCROLL_DISABLE_CLASS);
}
...
links.forEach(function (e) {
  ...
  e.openModalBtn.addEventListener("click", function () {
    document.body.classList.toggle("modal-open"), e.modal.classList.toggle("is-hidden"), e.openModalBtn.classList.toggle("is-active");
  });
}(), function () {
  var e = {
  ...
  function i() {
    document.body.classList.toggle("modal-consultation"), e.modal.classList.toggle("is-hidden");
  }
  ...
  o = 0, (l = function l(e, i) {
    ...
    o.unload(), "number" == typeof i ? 0 === i && 0 === o.$slides.length ? a(e).appendTo(o.$slideTrack) : t ? a(e).insertBefore(o.$slides.eq(i)) : a(e).insertAfter(o.$slides.eq(i)) : !0 === t ? a(e).prependTo(o.$slideTrack) : a(e).appendTo(o.$slideTrack), o.$slides = o.$slideTrack.children(this.options.slide), o.$slideTrack.children(this.options.slide).detach(), o.$slideTrack.append(o.$slides), o.$slides.each(function (e, i) {
      a(i).attr("data-slick-index", e);
    }), o.$slidesCache = o.$slides, o.reinit();
  }, l.prototype.animateHeight = function () {
    var e,
        i = this;
    1 === i.options.slidesToShow && !0 === i.options.adaptiveHeight && !1 === i.options.vertical && (e = i.$slides.eq(i.currentSlide).outerHeight(!0), i.$list.animate({
      height: e
    }, i.options.speed));
    ...
    o.animateHeight(), !0 === o.options.rtl && !1 === o.options.vertical && (e = -e), !1 === o.transformsEnabled ? !1 === o.options.vertical ? o.$slideTrack.animate({
      ...
      top: e
    }, o.options.speed, o.options.easing, i) : !1 === o.cssTransitions ? (!0 === o.options.rtl && (o.currentLeft = -o.currentLeft), a({
    ...
    var i = this,
        t = {};
    !1 === i.options.fade ? t[i.transitionType] = i.transformType + " " + i.options.speed + "ms " + i.options.cssEase : t[i.transitionType] = "opacity " + i.options.speed + "ms " + i.options.cssEase, (!1 === i.options.fade ? i.$slideTrack : i.$slides.eq(e)).css(t);
    ...
    var e = this;
    !0 === e.options.arrows && (e.$prevArrow = a(e.options.prevArrow).addClass("slick-arrow"), e.$nextArrow = a(e.options.nextArrow).addClass("slick-arrow"), e.slideCount > e.options.slidesToShow ? (e.$prevArrow.removeClass("slick-hidden").removeAttr("aria-hidden tabindex"), e.$nextArrow.removeClass("slick-hidden").removeAttr("aria-hidden tabindex"), e.htmlExpr.test(e.options.prevArrow) && e.$prevArrow.prependTo(e.options.appendArrows), e.htmlExpr.test(e.options.nextArrow) && e.$nextArrow.appendTo(e.options.appendArrows), !0 !== e.options.infinite && e.$prevArrow.addClass("slick-disabled").attr("aria-disabled", "true")) : e.$prevArrow.add(e.$nextArrow).addClass("slick-hidden").attr({
      "aria-disabled": "true",
      tabindex: "-1"
    }));
    ...
    if (!0 === t.options.dots) {
      for (t.$slider.addClass("slick-dotted"), i = a("<ul />").addClass(t.options.dotsClass), e = 0; e <= t.getDotCount(); e += 1) {
        i.append(a("<li />").append(t.options.customPaging.call(this, t, e)));
      }
    ...
    e.$slides = e.$slider.children(e.options.slide + ":not(.slick-cloned)").addClass("slick-slide"), e.slideCount = e.$slides.length, e.$slides.each(function (e, i) {
      a(i).attr("data-slick-index", e).data("originalStyling", a(i).attr("style") || "");
    }), e.$slider.addClass("slick-slider"), e.$slideTrack = 0 === e.slideCount ? a('<div class="slick-track"/>').appendTo(e.$slider) : e.$slides.wrapAll('<div class="slick-track"/>').parent(), e.$list = e.$slideTrack.wrap('<div class="slick-list"/>').parent(), e.$slideTrack.css("opacity", 0), !0 !== e.options.centerMode && !0 !== e.options.swipeToSlide || (e.options.slidesToScroll = 1), a("img[data-lazy]", e.$slider).not("[src]").addClass("slick-loading"), e.setupInfinite(), e.buildArrows(), e.buildDots(), e.updateDots(), e.setSlideClasses("number" == typeof e.currentSlide ? e.currentSlide : 0), !0 === e.options.draggable && e.$list.addClass("draggable");
      ...
      for (t = o.options.slidesPerRow * o.options.rows, i = Math.ceil(n.length / t), e = 0; e < i; e++) {
        for (var l = document.createElement("div"), r = 0; r < o.options.rows; r++) {
          for (var d = document.createElement("div"), a = 0; a < o.options.slidesPerRow; a++) {
            var c = e * t + (r * o.options.slidesPerRow + a);
    ...
    if ("window" === n.respondTo ? s = d : "slider" === n.respondTo ? s = r : "min" === n.respondTo && (s = Math.min(d, r)), n.options.responsive && n.options.responsive.length && null !== n.options.responsive) {
      ...
      null !== o ? null !== n.activeBreakpoint && o === n.activeBreakpoint && !i || (n.activeBreakpoint = o, "unslick" === n.breakpointSettings[o] ? n.unslick(o) : (n.options = a.extend({}, n.originalSettings, n.breakpointSettings[o]), !0 === e && (n.currentSlide = n.options.initialSlide), n.refresh(e)), l = o) : null !== n.activeBreakpoint && (n.activeBreakpoint = null, n.options = n.originalSettings, !0 === e && (n.currentSlide = n.options.initialSlide), n.refresh(e), l = o), e || !1 === l || n.$slider.trigger("breakpoint", [n, l]);
    }
    ...
    var i = this.getNavigableIndexes(),
        t = 0;
    if (e > i[i.length - 1]) e = i[i.length - 1];else for (var o in i) {
      if (e < i[o]) {
        e = t;
        break;
      }
    ...
    if (!0 === e.options.infinite) {
      if (e.slideCount <= e.options.slidesToShow) ++o;else for (; i < e.slideCount;) {
        ++o, i = t + e.options.slidesToScroll, t += e.options.slidesToScroll <= e.options.slidesToShow ? e.options.slidesToScroll : e.options.slidesToShow;
      }
    } else if (!0 === e.options.centerMode) o = e.slideCount;else if (e.options.asNavFor) for (; i < e.slideCount;) {
      ++o, i = t + e.options.slidesToScroll, t += e.options.slidesToScroll <= e.options.slidesToShow ? e.options.slidesToScroll : e.options.slidesToShow;
    ...
    var i,
        ...
        o = this,
        s = 0;
    return o.slideOffset = 0, i = o.$slides.first().outerHeight(!0), !0 === o.options.infinite ? (o.slideCount > o.options.slidesToShow && (o.slideOffset = o.slideWidth * o.options.slidesToShow * -1, t = -1, !0 === o.options.vertical && !0 === o.options.centerMode && (2 === o.options.slidesToShow ? t = -1.5 : 1 === o.options.slidesToShow && (t = -2)), s = i * o.options.slidesToShow * t), o.slideCount % o.options.slidesToScroll != 0 && e + o.options.slidesToScroll > o.slideCount && o.slideCount > o.options.slidesToShow && (s = e > o.slideCount ? (o.slideOffset = (o.options.slidesToShow - (e - o.slideCount)) * o.slideWidth * -1, (o.options.slidesToShow - (e - o.slideCount)) * i * -1) : (o.slideOffset = o.slideCount % o.options.slidesToScroll * o.slideWidth * -1, o.slideCount % o.options.slidesToScroll * i * -1))) : e + o.options.slidesToShow > o.slideCount && (o.slideOffset = (e + o.options.slidesToShow - o.slideCount) * o.slideWidth, s = (e + o.options.slidesToShow - o.slideCount) * i), o.slideCount <= o.options.slidesToShow && (s = o.slideOffset = 0), !0 === o.options.centerMode && o.slideCount <= o.options.slidesToShow ? o.slideOffset = o.slideWidth * Math.floor(o.options.slidesToShow) / 2 - o.slideWidth * o.slideCount / 2 : !0 === o.options.centerMode && !0 === o.options.infinite ? o.slideOffset += o.slideWidth * Math.floor(o.options.slidesToShow / 2) - o.slideWidth : !0 === o.options.centerMode && (o.slideOffset = 0, o.slideOffset += o.slideWidth * Math.floor(o.options.slidesToShow / 2)), i = !1 === o.options.vertical ? e * o.slideWidth * -1 + o.slideOffset : e * i * -1 + s, !0 === o.options.variableWidth && (s = o.slideCount <= o.options.slidesToShow || !1 === o.options.infinite ? o.$slideTrack.children(".slick-slide").eq(e) : o.$slideTrack.children(".slick-slide").eq(e + o.options.slidesToShow), i = !0 === o.options.rtl ? s[0] ? -1 * (o.$slideTrack.width() - s[0].offsetLeft - s.width()) : 0 : s[0] ? -1 * s[0].offsetLeft : 0, !0 === o.options.centerMode && (s = o.slideCount <= o.options.slidesToShow || !1 === o.options.infinite ? o.$slideTrack.children(".slick-slide").eq(e) : o.$slideTrack.children(".slick-slide").eq(e + o.options.slidesToShow + 1), i = !0 === o.options.rtl ? s[0] ? -1 * (o.$slideTrack.width() - s[0].offsetLeft - s.width()) : 0 : s[0] ? -1 * s[0].offsetLeft : 0, i += (o.$list.width() - s.outerWidth()) / 2)), i;
    ...
    return !0 === o.options.swipeToSlide ? (o.$slideTrack.find(".slick-slide").each(function (e, i) {
    ...
    var e = this;
    !0 === e.options.dots && (a("li", e.$dots).on("click.slick", {
      message: "index"
    }, e.changeSlide), !0 === e.options.accessibility && e.$dots.on("keydown.slick", e.keyHandler)), !0 === e.options.dots && !0 === e.options.pauseOnDotsHover && a("li", e.$dots).on("mouseenter.slick", a.proxy(e.interrupt, e, !0)).on("mouseleave.slick", a.proxy(e.interrupt, e, !1));
    ...
    var i,
        ...
        o,
        n = this;
    if (!0 === n.options.centerMode ? o = !0 === n.options.infinite ? (t = n.currentSlide + (n.options.slidesToShow / 2 + 1)) + n.options.slidesToShow + 2 : (t = Math.max(0, n.currentSlide - (n.options.slidesToShow / 2 + 1)), n.options.slidesToShow / 2 + 1 + 2 + n.currentSlide) : (t = n.options.infinite ? n.options.slidesToShow + n.currentSlide : n.currentSlide, o = Math.ceil(t + n.options.slidesToShow), !0 === n.options.fade && (0 < t && t--, o <= n.slideCount && o++)), i = n.$slider.find(".slick-slide").slice(t, o), "anticipated" === n.options.lazyLoad) for (var s = t - 1, l = o, r = n.$slider.find(".slick-slide"), d = 0; d < n.options.slidesToScroll; d++) {
    ...
    var i = this;
    i.unslicked || (i.$slider.trigger("afterChange", [i, e]), i.animating = !1, i.slideCount > i.options.slidesToShow && i.setPosition(), i.swipeLeft = null, i.options.autoplay && i.autoPlay(), !0 === i.options.accessibility && (i.initADA(), i.options.focusOnChange && a(i.$slides.get(i.currentSlide)).attr("tabindex", 0).focus()));
    ...
    var i,
        ...
        s,
        n = this,
        l = a("img[data-lazy]", n.$slider);
    l.length ? (i = l.first(), t = i.attr("data-lazy"), o = i.attr("data-srcset"), s = i.attr("data-sizes") || n.$slider.attr("data-sizes"), (l = document.createElement("img")).onload = function () {
      o && (i.attr("srcset", o), s && i.attr("sizes", s)), i.attr("src", t).removeAttr("data-lazy data-srcset data-sizes").removeClass("slick-loading"), !0 === n.options.adaptiveHeight && n.setPosition(), n.$slider.trigger("lazyLoaded", [n, i, t]), n.progressiveLazyLoad();
    }, l.onerror = function () {
      e < 3 ? setTimeout(function () {
        n.progressiveLazyLoad(e + 1);
      }, 500) : (i.removeAttr("data-lazy").removeClass("slick-loading").addClass("slick-lazyload-error"), n.$slider.trigger("lazyLoadError", [n, i, t]), n.progressiveLazyLoad());
    }, l.src = t) : n.$slider.trigger("allImagesLoaded", [n]);
  }, l.prototype.refresh = function (e) {
    var i = this,
        t = i.slideCount - i.options.slidesToShow;
    !i.options.infinite && i.currentSlide > t && (i.currentSlide = t), i.slideCount <= i.options.slidesToShow && (i.currentSlide = 0), t = i.currentSlide, i.destroy(!0), a.extend(i, i.initials, {
      currentSlide: t
    ...
    o.unload(), (!0 === t ? o.$slideTrack.children() : o.$slideTrack.children(this.options.slide).eq(e)).remove(), o.$slides = o.$slideTrack.children(this.options.slide), o.$slideTrack.children(this.options.slide).detach(), o.$slideTrack.append(o.$slides), o.$slidesCache = o.$slides, o.reinit();
    ...
    o.$slides.each(function (e, i) {
      t = o.slideWidth * e * -1, !0 === o.options.rtl ? a(i).css({
        position: "relative",
        right: t,
        top: 0,
    ...
    var e,
        ...
        n = this,
        l = !1;
    if ("object" === a.type(arguments[0]) ? (t = arguments[0], l = arguments[1], s = "multiple") : "string" === a.type(arguments[0]) && (t = arguments[0], o = arguments[1], l = arguments[2], "responsive" === arguments[0] && "array" === a.type(arguments[1]) ? s = "responsive" : void 0 !== arguments[1] && (s = "single")), "single" === s) n.options[t] = o;else if ("multiple" === s) a.each(t, function (e, i) {
      n.options[e] = i;
    });else if ("responsive" === s) for (i in o) {
      if ("array" !== a.type(n.options.responsive)) n.options.responsive = [o[i]];else {
        for (e = n.options.responsive.length - 1; 0 <= e;) {
          n.options.responsive[e].breakpoint === o[i].breakpoint && n.options.responsive.splice(e, 1), e--;
        }
    ...
    s.$slides.eq(e).addClass("slick-current"), !0 === s.options.centerMode ? (t = s.options.slidesToShow % 2 == 0 ? 1 : 0, o = Math.floor(s.options.slidesToShow / 2), !0 === s.options.infinite && (o <= e && e <= s.slideCount - 1 - o ? s.$slides.slice(e - o + t, e + o + 1).addClass("slick-active").attr("aria-hidden", "false") : (i = s.options.slidesToShow + e, n.slice(i - o + 1 + t, i + o + 2).addClass("slick-active").attr("aria-hidden", "false")), 0 === e ? n.eq(n.length - 1 - s.options.slidesToShow).addClass("slick-center") : e === s.slideCount - 1 && n.eq(s.options.slidesToShow).addClass("slick-center")), s.$slides.eq(e).addClass("slick-center")) : 0 <= e && e <= s.slideCount - s.options.slidesToShow ? s.$slides.slice(e, e + s.options.slidesToShow).addClass("slick-active").attr("aria-hidden", "false") : n.length <= s.options.slidesToShow ? n.addClass("slick-active").attr("aria-hidden", "false") : (o = s.slideCount % s.options.slidesToShow, i = !0 === s.options.infinite ? s.options.slidesToShow + e : e, (s.options.slidesToShow == s.options.slidesToScroll && s.slideCount - e < s.options.slidesToShow ? n.slice(i - (s.options.slidesToShow - o), i + o) : n.slice(i, i + s.options.slidesToShow)).addClass("slick-active").attr("aria-hidden", "false")), "ondemand" !== s.options.lazyLoad && "anticipated" !== s.options.lazyLoad || s.lazyLoad();
    ...
    if (!0 === o.options.fade && (o.options.centerMode = !1), !0 === o.options.infinite && !1 === o.options.fade && (i = null, o.slideCount > o.options.slidesToShow)) {
      for (t = !0 === o.options.centerMode ? o.options.slidesToShow + 1 : o.options.slidesToShow, e = o.slideCount; e > o.slideCount - t; --e) {
        i = e - 1, a(o.$slides[i]).clone(!0).attr("id", "").attr("data-slick-index", i - o.slideCount).prependTo(o.$slideTrack).addClass("slick-cloned");
      }

      for (e = 0; e < t + o.slideCount; e += 1) {
        i = e, a(o.$slides[i]).clone(!0).attr("id", "").attr("data-slick-index", i + o.slideCount).appendTo(o.$slideTrack).addClass("slick-cloned");
      }
    ...
    e = a(e.target).is(".slick-slide") ? a(e.target) : a(e.target).parents(".slick-slide"), e = (e = parseInt(e.attr("data-slick-index"))) || 0;
    ...
    var o,
        ...
        l,
        r = this;
    if (i = i || !1, !(!0 === r.animating && !0 === r.options.waitForAnimate || !0 === r.options.fade && r.currentSlide === e)) if (!1 === i && r.asNavFor(e), o = e, l = r.getLeft(o), i = r.getLeft(r.currentSlide), r.currentLeft = null === r.swipeLeft ? i : r.swipeLeft, !1 === r.options.infinite && !1 === r.options.centerMode && (e < 0 || e > r.getDotCount() * r.options.slidesToScroll)) !1 === r.options.fade && (o = r.currentSlide, !0 !== t ? r.animateSlide(i, function () {
      r.postSlide(o);
    }) : r.postSlide(o));else if (!1 === r.options.infinite && !0 === r.options.centerMode && (e < 0 || e > r.slideCount - r.options.slidesToScroll)) !1 === r.options.fade && (o = r.currentSlide, !0 !== t ? r.animateSlide(i, function () {
      r.postSlide(o);
    }) : r.postSlide(o));else {
      if (r.options.autoplay && clearInterval(r.autoPlayTimer), s = o < 0 ? r.slideCount % r.options.slidesToScroll != 0 ? r.slideCount - r.slideCount % r.options.slidesToScroll : r.slideCount + o : o >= r.slideCount ? r.slideCount % r.options.slidesToScroll != 0 ? 0 : o - r.slideCount : o, r.animating = !0, r.$slider.trigger("beforeChange", [r, r.currentSlide, s]), i = r.currentSlide, r.currentSlide = s, r.setSlideClasses(r.currentSlide), r.options.asNavFor && (n = (n = r.getNavTarget()).slick("getSlick")).slideCount <= n.options.slidesToShow && n.setSlideClasses(r.currentSlide), r.updateDots(), r.updateArrows(), !0 === r.options.fade) return !0 !== t ? (r.fadeSlideOut(i), r.fadeSlide(s, function () {
        r.postSlide(s);
    ...
    var e = this,
        ...
        i = Math.atan2(t, i);
    return (i = Math.round(180 * i / Math.PI)) < 0 && (i = 360 - Math.abs(i)), i <= 45 && 0 <= i || i <= 360 && 315 <= i ? !1 === e.options.rtl ? "left" : "right" : 135 <= i && i <= 225 ? !1 === e.options.rtl ? "right" : "left" : !0 === e.options.verticalSwiping ? 35 <= i && i <= 135 ? "down" : "up" : "vertical";
    ...
    for (var e, i = this, t = arguments[0], o = Array.prototype.slice.call(arguments, 1), s = i.length, n = 0; n < s; n++) {
      if ("object" == _typeof(t) || void 0 === t ? i[n].slick = new l(i[n], t) : e = i[n].slick[t].apply(i[n].slick, o), void 0 !== e) return e;
    }
...
$(window).scroll(function () {
  1200 < $(window).scrollTop() ? btn.addClass("show") : btn.removeClass("show");
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/main-min.js"], null)
//# sourceMappingURL=/main-min.ab289f5d.js.map